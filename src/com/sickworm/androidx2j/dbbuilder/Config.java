...
//        android.support.v7.widget.GridLayout.class,
    ...
    public static final String[] ADDITION_LIST = new String[] {
        ...
        "View,android:background,setBackgroundDrawable(Drawable),",
        "View,android:background,setBackgroundColor(int),",
        ...
        "ListView,android:dividerHeight,setDividerHeight(int),",
        ...
        "TextView,android:drawableStart,setCompoundDrawablesRelativeWithIntrinsicBounds(Drawable,Drawable,Drawable,Drawable)," + (1 << TYPE_ARGUMENTS_ORDER_INDEX),
        "TextView,android:drawableTop,setCompoundDrawablesRelativeWithIntrinsicBounds(Drawable,Drawable,Drawable,Drawable)," + (2 << TYPE_ARGUMENTS_ORDER_INDEX),
        "TextView,android:drawableEnd,setCompoundDrawablesRelativeWithIntrinsicBounds(Drawable,Drawable,Drawable,Drawable)," + (3 << TYPE_ARGUMENTS_ORDER_INDEX),
        "TextView,android:drawableBottom,setCompoundDrawablesRelativeWithIntrinsicBounds(Drawable,Drawable,Drawable,Drawable)," + (4 << TYPE_ARGUMENTS_ORDER_INDEX),
        ...
        "TextView,android:drawableLeft,setCompoundDrawablesWithIntrinsicBounds(Drawable,Drawable,Drawable,Drawable)," + (1 << TYPE_ARGUMENTS_ORDER_INDEX),
        "TextView,android:drawableTop,setCompoundDrawablesWithIntrinsicBounds(Drawable,Drawable,Drawable,Drawable)," + (2 << TYPE_ARGUMENTS_ORDER_INDEX),
        "TextView,android:drawableRight,setCompoundDrawablesWithIntrinsicBounds(Drawable,Drawable,Drawable,Drawable)," + (3 << TYPE_ARGUMENTS_ORDER_INDEX),
        "TextView,android:drawableBottom,setCompoundDrawablesWithIntrinsicBounds(Drawable,Drawable,Drawable,Drawable)," + (4 << TYPE_ARGUMENTS_ORDER_INDEX),
        ...
        "TextView,android:textColor,setTextColor(ColorStateList),",
        ...
        //"View,android:layout_alignWithParentIfMissing,addRule(RelativeLayout.,int)," + (TYPE_LAYOUT_PARAMETER + (2 << TYPE_ARGUMENTS_ORDER_INDEX)),   //no relative
        ...
        //"View,android:layout_centerInParent,addRule(RelativeLayout.,int)," + (TYPE_LAYOUT_PARAMETER + (2 << TYPE_ARGUMENTS_ORDER_INDEX)),            //no relative
        ...
        "GradientDrawable,android:topLeftRadius,setCornerRadii(float,float,float,float)," + (TYPE_ARGUMENTS_ARRAY + (1 << TYPE_ARGUMENTS_ORDER_INDEX)),
        "GradientDrawable,android:topRightRadius,setCornerRadii(float,float,float,float)," + (TYPE_ARGUMENTS_ARRAY + (2 << TYPE_ARGUMENTS_ORDER_INDEX)),
        "GradientDrawable,android:bottomRightRadius,setCornerRadii(float,float,float,float)," + (TYPE_ARGUMENTS_ARRAY + (3 << TYPE_ARGUMENTS_ORDER_INDEX)),
        "GradientDrawable,android:bottomLeftRadius,setCornerRadii(float,float,float,float)," + (TYPE_ARGUMENTS_ARRAY + (4 << TYPE_ARGUMENTS_ORDER_INDEX)),
    ...
    public static String[] REMOVAL_LIST = new String[] {
        "View,android:background,setBackgroundResource(int),",
